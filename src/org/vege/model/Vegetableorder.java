...
public class Vegetableorder {
  ...
  public Vegetableorder(Long id, Long foodid, Long userid, Long foodnumber, Long sellerid, Timestamp create_date, String getfoodtime, Long isfinish, String foodcode) {
    this.id = id;
    this.foodid = foodid;
    this.userid = userid;
